...
The client can use the calendar in order to view available dates that are available for appointments. Once a valid date is selected, then the client can confirm an appointment with a provider.
