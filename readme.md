...
The client can use the calendar in order to view available dates they can book an appointment with a provider. Once a valid date is selected, then the client can confirm an appointment with a provider.
